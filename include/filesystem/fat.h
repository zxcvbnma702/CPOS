#ifndef __CPOS__FILESYSTEM__FAT_H
#define __CPOS__FILESYSTEM__FAT_H
 ...
 * @brief 
 *  详见
 *  https://pic4.zhimg.com/80/v2-92b10fda140ac799cc602030c5d991df_720w.jpg
 */
...
namespace cpos
{
    namespace filesystem
    {
         ...
         *  @brief 
         *  引导扇区结构表
         *  https://smms.app/image/ETl34fsYHPZeKjd
         */
         ...
         * @brief 
         * 短目录项结构
         * https://smms.app/image/fHIqXOvMZez8yD7
         */
        ...
        void ReadBiosBlock(cpos::drivers::AdvancedTechnologyAttachment *hd, common::uint32_t partitionOffset);
    }
}
