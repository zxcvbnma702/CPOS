#ifndef __CPOS__DRIVERS__AMD_AM79C973_H
#define __CPOS__DRIVERS__AMD_AM79C973_H
...
namespace cpos
{
    namespace drivers
    {
        ...
        public:
            amd_am79c973(hardwarecommunication::PeripheralComponentInterconnectDeviceDescriptor* dev, hardwarecommunication::InterruptManager* interrupt);
            ~amd_am79c973();
